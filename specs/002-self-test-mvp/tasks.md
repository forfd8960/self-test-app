...
- [ ] T001 Create backend workspace skeleton in backend/Cargo.toml and backend/src/main.rs
- [ ] T002 Create frontend app skeleton in frontend/package.json and frontend/src/main.tsx
- [ ] T003 [P] Configure backend formatting/linting in backend/rustfmt.toml and backend/.clippy.toml
- [ ] T004 [P] Configure frontend linting/formatting in frontend/.eslintrc.cjs and frontend/.prettierrc
- [ ] T005 [P] Add environment templates in backend/.env.example and frontend/.env.example
...
- [ ] T006 Create backend config loader in backend/src/config/mod.rs
...
- [ ] T014 Add SQLx migrations baseline in backend/migrations/0001_init.sql
- [ ] T015 [P] Add frontend API client wrapper in frontend/src/lib/api.ts
- [ ] T016 [P] Add frontend auth store in frontend/src/features/auth/store.ts
...
- [ ] T017 [P] [US1] Backend integration tests for auth endpoints in backend/tests/auth_flow.rs
- [ ] T018 [P] [US1] Backend integration tests for material upload in backend/tests/materials_flow.rs
- [ ] T019 [P] [US1] Backend integration tests for generation endpoints in backend/tests/generation_flow.rs
- [ ] T020 [P] [US1] Frontend auth flow tests in frontend/tests/auth.spec.tsx
- [ ] T021 [P] [US1] Frontend upload + generation tests in frontend/tests/generation.spec.tsx
...
- [ ] T025 [P] [US1] Implement QuestionSet + Question models in backend/src/domain/question.rs
- [ ] T026 [US1] Implement auth service in backend/src/services/auth_service.rs
- [ ] T027 [US1] Implement material upload service in backend/src/services/material_service.rs
- [ ] T028 [US1] Implement text extraction pipeline in backend/src/services/extraction_service.rs
- [ ] T029 [US1] Implement generation service with job status in backend/src/services/generation_service.rs
- [ ] T030 [US1] Implement auth routes in backend/src/api/auth.rs
- [ ] T031 [US1] Implement materials routes in backend/src/api/materials.rs
- [ ] T032 [US1] Implement generation routes in backend/src/api/generation.rs
- [ ] T033 [US1] Add SQLx queries for US1 entities in backend/src/infra/repositories.rs
- [ ] T034 [P] [US1] Build auth UI screens in frontend/src/features/auth/pages
- [ ] T035 [P] [US1] Build upload UI in frontend/src/features/materials/pages
- [ ] T036 [P] [US1] Build generation setup UI in frontend/src/features/generation/pages
- [ ] T037 [US1] Implement generation API calls in frontend/src/features/generation/api.ts
- [ ] T038 [US1] Implement question list page in frontend/src/features/generation/components/QuestionList.tsx
